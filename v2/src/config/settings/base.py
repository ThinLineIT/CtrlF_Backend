...
DATABASES = {
    "default": {
        ...
        "NAME": env.str("RDS_DB_NAME", default=""),
        "USER": env.str("RDS_USERNAME", default=""),
        "PASSWORD": env.str("RDS_PASSWORD", default=""),
        "HOST": env.str("RDS_HOSTNAME", default="localhost"),
        "PORT": env.str("RDS_PORT", default="5432"),
    }
}
