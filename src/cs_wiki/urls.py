...
from cs_wiki.views import CategoryListView, NoteListView, AllPageCountView, IssueListView, PageDetailView, TopicListView, PageListView, AllPageListView
...
urlpatterns = [
    ...
    path("notes/<int:note_id>/", AllPageListView.as_view()),
